        ...
        {currentItems.map((item, i) => {
          return (
            <tr key={i}>
              ...
              <td>
                <Button className="btn btn-xs btn-danger" onClick={() => onRemove(item.id)}>Delete</Button>
                <Button className="btn btn-xs btn-warning" onClick={() => onEdit(item)}>Edit</Button>
      ...
      <table className="table">
        <thead>
          <tr>
            ...
            <th scope="col" onClick={() => sortingTitle()}>toDO</th>
            <th scope="col" onClick={() => sortingCompleted()}>Status</th>
